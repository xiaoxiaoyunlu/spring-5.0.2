...
public abstract class AbstractAutoProxyCreator extends ProxyProcessorSupport
	...
	public Object postProcessAfterInitialization(@Nullable Object bean, String beanName) throws BeansException {
		if (bean != null) {
			// 根据给定的bean的class  和 beanName 生成一个 cache key
	...
	protected Object wrapIfNecessary(Object bean, String beanName, Object cacheKey) {
		...
		// 基础设施类不应该被增强， 或者看看 是否需要跳过 不需要自动代理
	...
	protected Object createProxy(Class<?> beanClass, @Nullable String beanName,
		...
		// 判断 对于给定的bean,是否应该强制使用cglib，
		// 就是去判断属性 proxy-target-class
		...
		//specificInterceptors 指定的拦截器 集合
		// 获取 需要
		...
		// 用来控制代理工厂被设置以后，是否还允许修改通知？，缺省值为 false, 即 在代理被配置以后，不允许修改代理的配置
